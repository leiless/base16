...
#ifndef __NANO_BASE16_H
#define __NANO_BASE16_H
...
static const uint16_t __base16_enc_le16__[] = {
...
static const uint16_t __base16_enc_be16__[] = {
 ...
 */
void nano_base16_encode_baseline(
        char * restrict dst,
...
/**
 * Optimized base16 encoding(hopefully faster than baseline version?)
 * With minimal .data segment storage overhead(around 1kb)
 * see: nano_base16_encode_baseline
 */
void nano_base16_encode(
        char * restrict dst,
        const void * restrict src,
        size_t n)
{
    static const uint16_t *tabvec[] = {
        __base16_enc_le16__, __base16_enc_be16__,
    };
    ...
    if (tab == NULL) tab = tabvec[*((const uint8_t *) &magic)];
